        ...
        <ul className="flex flex-col gap-4 mt-4 md:hidden">
          ...
          {!session ? (
            <Link href="/login"  onClick={() => setOpen(false)}>
              <button className="bg-purple-500 rounded-lg px-3 py-1 cursor-pointer font-bold w-fit">
                Sign In / Up
              </button>
            </Link>
          ) : (
            <button
              ...
              className="bg-purple-500 rounded-lg cursor-pointer px-3 py-1 font-bold w-fit"
            >
              Logout
            </button>
          )}
