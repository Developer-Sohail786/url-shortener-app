...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f3e8ff] px-4">
      ...
      <div className="w-full max-w-md sm:max-w-lg md:max-w-xl bg-white shadow-xl rounded-2xl text-purple-900 py-10 px-6 sm:px-10 border border-purple-200">
        ...
        <p className="text-purple-600 text-center mt-2 text-sm sm:text-base">
          Login to manage your short URLs securely
        </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5">
          ...
          <div className="pt-2 flex justify-center">
            <button
              ...
              className={`h-12 w-1/2  rounded-lg font-semibold text-lg transition-all cursor-pointer duration-300
              ${isSubmitting
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            >
              <path
                fill="#FFC107"
                d="M43.6 20.5H42V20H24v8h11.3C33.6 32.9 29.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.7 1.1 7.8 2.9l5.7-5.7C33.9 6.1 29.2 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.3-.1-2.3-.4-3.5z"
              />
              <path
                fill="#FF3D00"
                d="M6.3 14.7l6.6 4.8C14.5 16 18.9 12 24 12c3 0 5.7 1.1 7.8 2.9l5.7-5.7C33.9 6.1 29.2 4 24 4 16.3 4 9.7 8.4 6.3 14.7z"
              />
              <path
                fill="#4CAF50"
